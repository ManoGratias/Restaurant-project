...
<header class="header">
    ...
    <a href="#" class="logo"> <i class="fas fa-utensils"></i> Mano'<span style="color:#27AE60 ">burger</span></a>
    ...
    <div class="icons">
        ...
        <a href="{{ route('profile.edit') }}"><div id="login-btn" class="fas fa-user"></div></a>
        ...
        <a href="{{ route('login') }}" class="btn">Se connecter</a>
              ...
              <form method="POST" action="{{ route('logout') }}">
                        @csrf
                    <a class="btn" onclick="event.preventDefault();this.closest('form').submit();" class="dropdown-item"  href="route('logout')">Déconnexion</a>
              @endguest
    </div>
        ...
        <div class="box-container">
            ...
            <div class="box">
                ...
                <div class="content">
                    ...
                    <br>
                    <span> price : </span>
                    <span class="price"> fcfa 4500 </span>
                </div>
            </div>
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <div class="content">
                ...
                <div class="price">fcfa 4500<span>fcfa 6000</span></div>
...
<section class="footer">
    ...
    <div class="bottom">
        ...
        <div class="credit"> created <span>Coding™</span> | all rights reserved! </div>
